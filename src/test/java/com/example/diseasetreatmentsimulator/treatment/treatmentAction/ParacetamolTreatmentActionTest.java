...
public class ParacetamolTreatmentActionTest {

    private ParacetamolTreatmentAction sut;

    @BeforeEach
    void warmUp() {
        sut = new ParacetamolTreatmentAction(DrugType.PARACETAMOL);
    }
    ...
    void treat_patientDead_whenAspirinAndParacetamol() {
        //Given
        TreatmentTask task = new TreatmentTask(PatientState.FEVER, List.of(DrugType.ASPIRIN));
